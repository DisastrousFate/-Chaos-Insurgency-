...
namespace Robot {
    ...
    private:
        ...
        /**
         * @brief Drives the robot using double stick arcade drive.
         *
         * Double stick arcade drive uses the left joystick for forward and backward movement, and the right joystick for turning.
         *
         */
         ...
         * 
         * Curvature drive uses the left joystick for forward and backward movement, and the left joystick for turning.
         */
        void CurvatureDrive();

        /**
         * @brief Drives the robot using double curvature drive.
         * 
         * Double curvature drive uses the left joystick for forward and backward movement, and the right joystick for turning.
         */
